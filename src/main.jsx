...
function applyDocRoiChrome() {
  ...
  if (root && !document.querySelector('.docroi-final')) {
    root.insertAdjacentHTML('afterend', `
      <footer class="docroi-final" id="docroi-final">
        <section class="docroi-diiip" aria-label="Metodología DIIIP">
          <div class="docroi-final-inner">
            <div class="diiip-heading"><h2>DIIIP</h2><p>Diagnosticar, interpretar, implementar, iterar y proyectar. El prompt no es el final: es la entrada a un sistema de mejora.</p></div>
            <div class="diiip-cards"><article>Detecta el problema real antes de pedir producción.</article><article>Convierte información dispersa en criterio útil.</article><article>Baja la respuesta a una acción concreta.</article></div>
          </div>
        </section>
        <section class="docroi-kai"><div class="docroi-final-inner kai-grid"><h2>KAI · ROI</h2><p>Cuando la IA se integra en procesos medibles, deja de ser una prueba suelta y se convierte en activo operativo.</p></div></section>
        <section class="docroi-legal-footer">
          <div class="docroi-final-inner legal-grid"><div><a href="${botiquinUrl}" target="_blank" rel="noreferrer" class="footer-logo" aria-label="Ir al Botiquín Doc ROI"><img src="${logoUrl}" alt="Doc ROI"></a><strong>Doc ROI · Connection 00</strong><span>Ingeniería de Prompts · Aprende jugando</span></div><a href="#top" class="back-top">Volver arriba</a></div>
          <div class="footer-links"><a href="https://docroi.marketing/aviso-legal/" target="_blank" rel="noreferrer">Política de privacidad</a><span>|</span><a href="https://docroi.marketing/aviso-legal/" target="_blank" rel="noreferrer">Aviso legal</a><span>|</span><a href="https://docroi.marketing/aviso-legal/" target="_blank" rel="noreferrer">Propiedad intelectual</a></div>
          <p class="footer-owner">La propiedad intelectual del ecosistema Doc ROI pertenece al <a href="https://docroi.marketing/ph-d-jorge-lucio/" target="_blank" rel="noreferrer">Ph. D. Jorge Lucio Sánchez Galán.</a></p>
        </section>
      </footer>`);
  }
}
